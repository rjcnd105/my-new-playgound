...
import type Types = require("effect/Types");
...
export type FromAllStruct<Fields extends AllRecord> = Types.Simplify<
  {
    readonly [K in Extract<
      keyof Fields,
      SchemaKeys<Fields>
    >]: Schema.Schema.From<Fields[K]>;
  } & {
...
export type ToAllStruct<Fields extends AllRecord> = Types.Simplify<
  {
    readonly [K in Extract<
      keyof Fields,
      SchemaKeys<Fields>
